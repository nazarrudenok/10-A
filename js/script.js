function mon() {
    ...
    scheduleCont.innerHTML = `
            <div class="lesson">
                <div class="time">
                    <p class="first">8:00</p>
                    <p class="line">-</p>
                    <p class="second">8:45</p>
                </div>
                <p class="value">Економіка</p>
            </div>
            <div class="lesson">
                <div class="time">
                    <p class="first">8:50</p>
                    <p class="line">-</p>
                    <p class="second">9:35</p>
                </div>
                <p class="value">Економіка</p>
            </div>
            <div class="lesson">
                <div class="time">
                    <p class="first">9:45</p>
                    <p class="line">-</p>
            ...
            <div class="lesson">
                <div class="time">
                    <p class="first">10:45</p>
                    <p class="line">-</p>
                    <p class="second">11:30</p>
                </div>
                <p class="value">Геометрія</p>
            </div>
            <div class="lesson">
                <div class="time">
            ...
            <div class="lesson">
                <div class="time">
                    <p class="first">12:35</p>
                    <p class="line">-</p>
                    <p class="second">13:30</p>
                </div>
                <p class="value">Українська мова</p>
            </div>
            <!-- <div class="lesson">
                <div class="time">
                    <p class="first">13:30</p>
                    <p class="line">-</p>
                    <p class="second">14:15</p>
                </div>
                <p class="value"></p>
            </div> -->
    `;
